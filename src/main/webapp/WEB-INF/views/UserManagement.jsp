...
<html>
  <head>  
    ...
    <style>
      ...
      .login.ng-dirty.ng-invalid-required {
          background-color: red;
      }
      .login.ng-dirty.ng-invalid-minlength {
                  ...
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.user.login" id="uname" class="login form-control input-sm" placeholder="Enter your name" required ng-minlength="3"/>
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.user.password" id="password" class="password form-control input-sm" placeholder="Enter your Password" required ng-minlength="8"/>
                                  <div class="has-error" ng-show="myForm.$dirty">
